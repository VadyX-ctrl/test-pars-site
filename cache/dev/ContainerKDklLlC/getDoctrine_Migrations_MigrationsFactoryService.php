 ...
 */
class getDoctrine_Migrations_MigrationsFactoryService extends App_Infrastructure_Symfony_KernelDevDebugContainer
{
    /**
    ...
    {
        include_once \dirname(__DIR__, 3).'/vendor/doctrine/migrations/src/Version/MigrationFactory.php';
