 ...
 */
class getMessenger_RoutableMessageBusService extends App_Infrastructure_Symfony_KernelDevDebugContainer
{
    /**
    ...
    {
        include_once \dirname(__DIR__, 3).'/vendor/symfony/messenger/MessageBusInterface.php';
        include_once \dirname(__DIR__, 3).'/vendor/symfony/messenger/RoutableMessageBus.php';
