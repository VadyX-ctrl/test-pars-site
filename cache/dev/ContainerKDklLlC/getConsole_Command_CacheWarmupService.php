 ...
 */
class getConsole_Command_CacheWarmupService extends App_Infrastructure_Symfony_KernelDevDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 3).'/vendor/symfony/framework-bundle/Command/CacheWarmupCommand.php';
