 ...
 */
class getMaker_FileLinkFormatterService extends App_Infrastructure_Symfony_KernelDevDebugContainer
{
    /**
    ...
    {
        include_once \dirname(__DIR__, 3).'/vendor/symfony/maker-bundle/src/Util/MakerFileLinkFormatter.php';
