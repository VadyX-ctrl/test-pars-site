 ...
 */
class getRedirectControllerService extends App_Infrastructure_Symfony_KernelDevDebugContainer
{
    /**
    ...
    {
        include_once \dirname(__DIR__, 3).'/vendor/symfony/framework-bundle/Controller/RedirectController.php';
