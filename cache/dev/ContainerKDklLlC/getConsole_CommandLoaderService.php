 ...
 */
class getConsole_CommandLoaderService extends App_Infrastructure_Symfony_KernelDevDebugContainer
{
    /**
    ...
    {
        include_once \dirname(__DIR__, 3).'/vendor/symfony/console/CommandLoader/CommandLoaderInterface.php';
        include_once \dirname(__DIR__, 3).'/vendor/symfony/console/CommandLoader/ContainerCommandLoader.php';
