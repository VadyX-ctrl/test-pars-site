 ...
 */
class getMaker_AutoCommand_MakeListenerService extends App_Infrastructure_Symfony_KernelDevDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 3).'/vendor/symfony/maker-bundle/src/Maker/MakeListener.php';
        include_once \dirname(__DIR__, 3).'/vendor/symfony/maker-bundle/src/EventRegistry.php';
