 ...
 */
class getDebug_ErrorHandlerConfiguratorService extends App_Infrastructure_Symfony_KernelDevDebugContainer
{
    /**
    ...
    {
        include_once \dirname(__DIR__, 3).'/vendor/symfony/http-kernel/Debug/ErrorHandlerConfigurator.php';
