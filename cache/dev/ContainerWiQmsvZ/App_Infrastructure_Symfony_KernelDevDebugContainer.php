 ...
 */
class App_Infrastructure_Symfony_KernelDevDebugContainer extends Container
{
    protected $targetDir;
    ...
    public function __construct(private array $buildParameters = [], protected string $containerDir = __DIR__)
    {
        ...
        $this->fileMap = [
            ...
            'app.parse_product.command' => 'getApp_ParseProduct_CommandService',
            'app.parse_product.controller' => 'getApp_ParseProduct_ControllerService',
            'app.parse_product.message_handler' => 'getApp_ParseProduct_MessageHandlerService',
        ...
        $this->aliases = [
            'database_connection' => 'doctrine.dbal.mysql_connection',
        ];
        ...
        $this->privates['service_container'] = static function ($container) {
            ...
            include_once \dirname(__DIR__, 3).'/vendor/symfony/service-contracts/ServiceCollectionInterface.php';
            ...
            include_once \dirname(__DIR__, 3).'/vendor/symfony/doctrine-bridge/Middleware/IdleConnection/Listener.php';
            include_once \dirname(__DIR__, 3).'/vendor/psr/log/src/LoggerInterface.php';
            include_once \dirname(__DIR__, 3).'/vendor/psr/log/src/LoggerTrait.php';
            include_once \dirname(__DIR__, 3).'/vendor/psr/log/src/AbstractLogger.php';
            include_once \dirname(__DIR__, 3).'/vendor/symfony/http-kernel/Log/DebugLoggerInterface.php';
            include_once \dirname(__DIR__, 3).'/vendor/symfony/http-kernel/Log/Logger.php';
    ...
    protected static function getHttpKernelService($container)
    {
        ...
        $a->allowControllers(['App\\Infrastructure\\Symfony\\Kernel', 'Doctrine\\Bundle\\DoctrineBundle\\Controller\\ProfilerController']);
    ...
    {
        return $container->privates['router_listener'] = new \Symfony\Component\HttpKernel\EventListener\RouterListener(($container->services['router'] ?? self::getRouterService($container)), ($container->services['request_stack'] ??= new \Symfony\Component\HttpFoundation\RequestStack()), ($container->privates['router.request_context'] ?? self::getRouter_RequestContextService($container)), ($container->privates['logger'] ?? self::getLoggerService($container)), \dirname(__DIR__, 3), true);
    }
    ...
    private function getDynamicParameter(string $name)
    {
        ...
        $value = match ($name) {
            ...
            'mysql.dsn' => $container->getEnv('resolve:DATABASE_URL'),
            'kernel.secret' => $container->getEnv('APP_SECRET'),
            'debug.file_link_format' => $container->getEnv('default::SYMFONY_IDE'),
            'debug.container.dump' => ($container->targetDir.''.'/App_Infrastructure_Symfony_KernelDevDebugContainer.xml'),
    ...
    protected function getDefaultParameters(): array
    {
        return [
            ...
            'kernel.container_class' => 'App_Infrastructure_Symfony_KernelDevDebugContainer',
            ...
            'doctrine.default_connection' => 'mysql',
            'doctrine.migrations.preferred_em' => NULL,
            'doctrine.migrations.preferred_connection' => NULL,
            'console.command.ids' => [
                0 => 'app.parse_product.command',
            ],
        ];
    }
}
