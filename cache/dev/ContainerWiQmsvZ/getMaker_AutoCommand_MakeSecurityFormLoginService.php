 ...
 */
class getMaker_AutoCommand_MakeSecurityFormLoginService extends App_Infrastructure_Symfony_KernelDevDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 3).'/vendor/symfony/maker-bundle/src/Maker/Common/CanGenerateTestsTrait.php';
        include_once \dirname(__DIR__, 3).'/vendor/symfony/maker-bundle/src/Maker/Security/MakeFormLogin.php';
        include_once \dirname(__DIR__, 3).'/vendor/symfony/maker-bundle/src/Security/SecurityConfigUpdater.php';
        include_once \dirname(__DIR__, 3).'/vendor/symfony/maker-bundle/src/Security/SecurityControllerBuilder.php';
