 ...
 */
class getCache_App_TaggableService extends App_Infrastructure_Symfony_KernelDevDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 3).'/vendor/symfony/cache/Adapter/TagAwareAdapterInterface.php';
        include_once \dirname(__DIR__, 3).'/vendor/symfony/cache-contracts/CacheInterface.php';
        include_once \dirname(__DIR__, 3).'/vendor/symfony/cache-contracts/TagAwareCacheInterface.php';
        ...
        include_once \dirname(__DIR__, 3).'/vendor/symfony/cache/Adapter/TagAwareAdapter.php';
