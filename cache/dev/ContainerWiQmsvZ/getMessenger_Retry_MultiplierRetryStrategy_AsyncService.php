 ...
 */
class getMessenger_Retry_MultiplierRetryStrategy_AsyncService extends App_Infrastructure_Symfony_KernelDevDebugContainer
{
    /**
    ...
    {
        include_once \dirname(__DIR__, 3).'/vendor/symfony/messenger/Retry/RetryStrategyInterface.php';
        include_once \dirname(__DIR__, 3).'/vendor/symfony/messenger/Retry/MultiplierRetryStrategy.php';
