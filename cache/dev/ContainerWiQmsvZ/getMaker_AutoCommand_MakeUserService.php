 ...
 */
class getMaker_AutoCommand_MakeUserService extends App_Infrastructure_Symfony_KernelDevDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 3).'/vendor/symfony/maker-bundle/src/Maker/Common/UidTrait.php';
        include_once \dirname(__DIR__, 3).'/vendor/symfony/maker-bundle/src/Maker/MakeUser.php';
        include_once \dirname(__DIR__, 3).'/vendor/symfony/maker-bundle/src/Security/UserClassBuilder.php';
